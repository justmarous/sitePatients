    ...
    return (
        <div style={style.loginWindow}>
            ...
            <div style={style.inputWindow}>
                <h2 style={style.h1}>Please enter your email, we will send you a link that will help you reset your password</h2>
                <p>ENTER EMAIL HERE</p>
                <input type={"text"} alt={"Enter your email"} style={style.input}  onChange={(e)=>setEmail( e.target.value)} />
                <button style={style.button} onClick={()=>dispatch(doReset())}>Send</button>
            </div>
        </div>
    );
}
