...
function Landing(props) {
    ...
    const stylePicture = {
        backgroundImage: "linear-gradient(to right,rgba(0, 128, 0, 0.8), rgba(15, 112, 1, 0.25)),url(https://images.unsplash.com/photo-1581952976147-5a2d15560349?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80)",
        position: "absolute",
